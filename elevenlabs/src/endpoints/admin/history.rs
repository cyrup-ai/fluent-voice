...
/// use speakrs_elevenlabs::endpoints::admin::history::{GetGeneratedItems, HistoryQuery};
///
/// #[tokio::main]
...
/// use speakrs_elevenlabs::endpoints::admin::history::GetHistoryItem;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::history::{
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::history::{GetGeneratedItems, GetAudio, HistoryQuery};
