//! File transcription builder implementation - Part 1
...
pub struct TranscriptionBuilderImpl<S> {
    ...
    pub(super) progress_template: Option<String>,
    ...
    S: TranscriptionStream,
{
    ...
    pub(super) async fn create_transcript(self) -> Result<TranscriptImpl<S>, VoiceError> {
