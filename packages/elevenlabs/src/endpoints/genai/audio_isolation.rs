...
/// use speakrs_elevenlabs::endpoints::genai::audio_isolation::AudioIsolation;
/// use speakrs_elevenlabs::utils::{play, save,};
///
/// #[tokio::main]
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::genai::audio_isolation::AudioIsolationStream;
/// use speakrs_elevenlabs::utils::{save, stream_audio};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let client = ElevenLabsClient::from_env()?;
