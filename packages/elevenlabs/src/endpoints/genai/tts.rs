...
/// # Example
/// ```no_run
/// use speakrs_elevenlabs::*;
/// use speakrs_elevenlabs::endpoints::genai::tts::{TextToSpeech, TextToSpeechBody};
///
/// use speakrs_elevenlabs::utils::play;
///
/// #[tokio::main]
...
/// # Example
/// ```ignore
///  use speakrs_elevenlabs::endpoints::admin::pronunciation::GetDictionaries;
///
...
/// ```no_run
/// use speakrs_elevenlabs::*;
/// use speakrs_elevenlabs::utils::stream_audio;
/// use speakrs_elevenlabs::endpoints::genai::tts::{TextToSpeechStream, TextToSpeechBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let c = ElevenLabsClient::from_env()?;
...
/// # Example
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result, Model, LegacyVoice};
/// use speakrs_elevenlabs::endpoints::genai::tts::{TextToSpeechWithTimestamps, TextToSpeechBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let c = ElevenLabsClient::from_env()?;
...
impl TextToSpeechWithTimestampsResponse {
    /* Commented out due to base64 dependency issues
...
/// ```no_run
/// use speakrs_elevenlabs::*;
/// use speakrs_elevenlabs::endpoints::genai::tts::{TextToSpeechStreamWithTimestamps, TextToSpeechBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let c = ElevenLabsClient::from_env()?;
...
pub mod ws {
    ...
    /// use speakrs_elevenlabs::endpoints::genai::tts::ws::*;
    /// use speakrs_elevenlabs::utils::{stream_audio, text_chunker};
    /// use speakrs_elevenlabs::*;
    ///
    /// #[tokio::main]
    /// async fn main() -> Result<()> {
