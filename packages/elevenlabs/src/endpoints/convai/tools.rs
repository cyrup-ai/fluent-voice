...
/// use speakrs_elevenlabs::endpoints::convai::tools::ListTools;
///
/// #[tokio::main]
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::convai::tools::GetTool;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::convai::agents::{ApiSchema, WebHook};
/// use speakrs_elevenlabs::endpoints::convai::tools::CreateTool;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::convai::tools::UpdateTool;
/// use speakrs_elevenlabs::endpoints::convai::agents::{ApiSchema, WebHook};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::convai::tools::DeleteTool;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
