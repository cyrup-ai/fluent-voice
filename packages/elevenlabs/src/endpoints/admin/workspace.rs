...
/// use speakrs_elevenlabs::endpoints::admin::workspace::InviteUser;
///
/// #[tokio::main]
...
/// ``` no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::workspace::DeleteInvitation;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ``` no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::workspace::{UpdateMember, UpdateMemberBody, WorkspaceRole};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::workspace::{GetResource, GetResourceQuery, ResourceType};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
