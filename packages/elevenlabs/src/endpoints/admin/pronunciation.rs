...
//!
//! See an extensive example [here](https://www.github.com/rwxbytes/speakrs_elevenlabs/blob/master/examples/pronunciation_dictionaries.rs).
use super::*;
...
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::{CreateDictionary, CreateDictionaryBody};
///
/// #[tokio::main]
...
/// # Example
/// ```no_run
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::CreateDictionaryBody;
///
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::{AddRules, AddRulesBody, Rule};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///   let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::{RemoveRules, RemoveRulesBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::{GetPLSFile, GetDictionaries};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::GetDictionaryMetaData;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::pronunciation::{GetDictionaries, GetDictionariesQuery};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
