...
/// use speakrs_elevenlabs::endpoints::admin::voice::{GetVoices, GetVoicesQuery, VoiceCategory, VoiceType};
///
/// #[tokio::main]
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::{GetVoiceSettings, VoiceSettings};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///   let c = ElevenLabsClient::from_env()?;
...
/// # Example
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result, DefaultVoice};
/// use speakrs_elevenlabs::endpoints::admin::voice::{GetVoice, GetVoiceResponse};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::DeleteVoice;
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///   let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::{EditVoiceSettings, EditVoiceSettingsBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///   let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::{AddVoice, VoiceBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///     let c = ElevenLabsClient::from_env()?;
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::{EditVoice, VoiceBody};
/// #[tokio::main]
///
/// async fn main() -> Result<()> {
...
/// ```no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::voice::{ListSimilarVoices, ListSimilarVoicesBody};
///
/// #[tokio::main]
/// async fn main() -> Result<()> {
///    let c = ElevenLabsClient::from_env()?;
