...
/// use speakrs_elevenlabs::endpoints::admin::samples::DeleteSample;
/// use speakrs_elevenlabs::endpoints::admin::voice::GetVoice;
///
/// #[tokio::main]
...
/// ``` no_run
/// use speakrs_elevenlabs::{ElevenLabsClient, Result};
/// use speakrs_elevenlabs::endpoints::admin::samples::GetAudioFromSample;
/// use speakrs_elevenlabs::endpoints::admin::voice::GetVoice;
