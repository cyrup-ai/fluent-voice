...
impl From<VoiceSpeed> for VoiceSpeedMod {
    fn from(speed: VoiceSpeed) -> Self {
        match speed {
            VoiceSpeed::XSlow => VoiceSpeedMod::XSlow,
            VoiceSpeed::Slow => VoiceSpeedMod::Slow,
            VoiceSpeed::Normal => VoiceSpeedMod::Normal,
            VoiceSpeed::Fast => VoiceSpeedMod::Fast,
            VoiceSpeed::XFast => VoiceSpeedMod::XFast,
        }
    }
}
